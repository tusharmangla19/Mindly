...
const colorSchemes = {
  unorganized: {
    bg: "bg-amber-100 hover:bg-amber-50 dark:bg-zinc-800 dark:hover:bg-zinc-700",
    tab: "bg-amber-200 group-hover:bg-amber-300 dark:bg-zinc-700 dark:group-hover:bg-zinc-600",
  },
  collection: {
    bg: "bg-blue-100 hover:bg-blue-50 dark:bg-zinc-800 dark:hover:bg-zinc-700",
    tab: "bg-blue-200 group-hover:bg-blue-300 dark:bg-zinc-700 dark:group-hover:bg-zinc-600",
  },
  createCollection: {
    bg: "bg-gray-200 hover:bg-gray-100 dark:bg-zinc-800 dark:hover:bg-zinc-700",
    tab: "bg-gray-100 hover:bg-gray-50 dark:bg-zinc-700 dark:hover:bg-zinc-600",
  },
};
