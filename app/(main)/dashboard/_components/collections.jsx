...
const Collections = ({ collections = [], entriesByCollection }) => {
  ...
  useEffect(() => {
    console.log('useEffect triggered. createdCollection:', createdCollection, 'createCollectionLoading:', createCollectionLoading);
  ...
  const handleCreateCollection = async (data) => {
    console.log('handleCreateCollection called with:', data);
